from errors import NgxParserDirectiveContextError, NgxParserDirectiveArgumentsError
...
NGX_CONF_NOARGS      = 0b00000000000000000000000000000001  # 0 args
NGX_CONF_TAKE1       = 0b00000000000000000000000000000010  # 1 args
NGX_CONF_TAKE2       = 0b00000000000000000000000000000100  # 2 args
NGX_CONF_TAKE3       = 0b00000000000000000000000000001000  # 3 args
NGX_CONF_TAKE4       = 0b00000000000000000000000000010000  # 4 args
NGX_CONF_TAKE5       = 0b00000000000000000000000000100000  # 5 args
NGX_CONF_TAKE6       = 0b00000000000000000000000001000000  # 6 args
NGX_CONF_TAKE7       = 0b00000000000000000000000010000000  # 7 args
NGX_CONF_BLOCK       = 0b00000000000000000000000100000000  # followed by block
NGX_CONF_FLAG        = 0b00000000000000000000001000000000  # 'on' or 'off'
NGX_CONF_ANY         = 0b00000000000000000000010000000000  # >=0 args
NGX_CONF_1MORE       = 0b00000000000000000000100000000000  # >=1 args
NGX_CONF_2MORE       = 0b00000000000000000001000000000000  # >=2 args
...
NGX_DIRECT_CONF      = 0b00000000000000010000000000000000  # main file (not used)
NGX_MAIN_CONF        = 0b00000000000001000000000000000000  # main context
NGX_EVENT_CONF       = 0b00000000000010000000000000000000  # events
NGX_MAIL_MAIN_CONF   = 0b00000000000100000000000000000000  # mail
NGX_MAIL_SRV_CONF    = 0b00000000001000000000000000000000  # mail > server
NGX_STREAM_MAIN_CONF = 0b00000000010000000000000000000000  # stream
NGX_STREAM_SRV_CONF  = 0b00000000100000000000000000000000  # stream > server
NGX_STREAM_UPS_CONF  = 0b00000001000000000000000000000000  # stream > upstream
NGX_HTTP_MAIN_CONF   = 0b00000010000000000000000000000000  # http
NGX_HTTP_SRV_CONF    = 0b00000100000000000000000000000000  # http > server
NGX_HTTP_LOC_CONF    = 0b00001000000000000000000000000000  # http > location
NGX_HTTP_UPS_CONF    = 0b00010000000000000000000000000000  # http > upstream
NGX_HTTP_SIF_CONF    = 0b00100000000000000000000000000000  # http > server > if
NGX_HTTP_LIF_CONF    = 0b01000000000000000000000000000000  # http > location > if
NGX_HTTP_LMT_CONF    = 0b10000000000000000000000000000000  # http > location > limit_except
...
def analyze(fname, stmt, term, ctx=()):
    ...
    for mask in reversed(masks):
        ...
        if ((mask >> n_args & 1 and n_args <= 7) or  # NOARGS to TAKE7
            (mask & NGX_CONF_FLAG and n_args == 1 and args[0] in ('on', 'off')) or
